...
```yaml
ports:
  - "127.0.0.1:11180:80"   # 访问 http://127.0.0.1:11180/
```
...
```yaml
ports:
  - "127.0.0.1:8080:80"    # http://127.0.0.1:8080/
```
...
ports:
  - "11180:80"             # 所有网卡
  # 或 "100.x.x.x:11180:80"  # 仅某网卡（如 Tailscale）
```

同时把 `.env` 里的 `ALLOWED_ORIGINS` 改成对应访问地址。
